...
echo "[Firewall Policy] Writing awall cloud-server.json"
...
echo "[Warning] please ensure that this is in sync with the actual config"
cat > /etc/awall/optional/cloud-server.json << EOF
. policy_firewall_cloud-server.json
EOF
